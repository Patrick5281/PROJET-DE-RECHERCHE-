...
?>
<?php
// URL de base pour les ressources
$base_url = "http://localhost/PROJET_DE_RECHERCHE/";
?>
<footer class="py-4">
    ...
    <div class="container">
      ...
      <div class="text-center mt-4">
        ...
        <p class="mb-0">© INSTI, UNSTIM 2024 - Réalisé par le groupe (HOUNTON KOUESSAN GNANHOUI ADJIDOME OGOUGBE)</p>
