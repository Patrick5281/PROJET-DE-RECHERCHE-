    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="showAnnonce.php">ANNONCES</a></li>

                <li class="nav-item"><a class="nav-link" href="showProjetAd.php">PROJETS DE RECHERCHE</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="showActivity.php">ACTIVITES</a></li>
